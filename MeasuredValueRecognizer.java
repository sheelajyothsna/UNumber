...
public class MeasuredValueRecognizer {
	...
	public MeasuredValueRecognizer(String input) {
		checkMeasureValue(input);
	}
...
//	public static boolean checkMeasureValue() {
//		return finalState;
//	}
	...
	public static String checkMeasureValue(String input) {
		...
		while (running) {
			...
			case 5: 
				...
				// If the current character is an 'E' or 'e", it transitions to state 6
